                ...
                <div class="header-wrap layout-full">
                    ...
                    <div class="home-heading">
                        <div class="home-logo">
                            ...
                            <p class="home-job-title">Front-End Developer</p>
                                        ...
                                        <div class="boxed is-dark">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <h2 class="fw-300">Hello, I am Demola Adebowale, a <strong>Front 
                                                        end Developer </strong> based in LA.
                                                        I have 9 years <strong>experience</strong> in web design and 
                                                        <strong>Applications development. I have collaborated with
                                                        teams, done remote work
                                                         </strong> for Agencies, startups and Non-profits.
                                                        </h2>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-3">
                                                ...
                                                <div class="service">
                                                    ...
                                                    <h3>Web Design</h3>
                                                    <p>I design unique website and Ecommerce that meets Brands expectation
                                                        I use Wordpress, joomla, Drupal, Prestashop and Magento also PHP with Laravel templating Engine</p>
                                                </div>
                                                <!-- service -->
                                            ...
                                            <div class="col-sm-6 col-lg-3">
                                                ...
                                                <div class="service">
                                                    ...
                                                    <h3>Front Dev</h3>
                                                    <p>I use HTML CSS, SaaS, Javacript Framework like ReactJs. 
                                                        to collaborate with Backend Teams with Good experience with backend development and processes
                                                        </p>
                                                </div>
                                                <!-- service -->
                                            ...
                                            <div class="col-sm-6 col-lg-3">
                                                ...
                                                <div class="service">
                                                    ...
                                                    <h3>Database Dev</h3>
                                                    <p>I use Sql, Sqlites, Postregs to develop database appication 
                                                        for small startups and non-profits. with familiarity of
                                                        remote applications like slack, Airtable, Zoom,and Dropbox.</p>
                                                </div>
                                                <!-- service -->
                                            ...
                                            <div class="col-sm-6 col-lg-3">
                                                ...
                                                <div class="service">
                                                    ...
                                                    <h3> Upstarts Ideation</h3>
                                                    <p>I help small startups with Brand designs, Tech research, and ideation. In my leisure time, I attend meetups and continually update my knowledge on emerging Tech trends.</p>
                                                </div>
                                                <!-- service -->
            ...
            <footer id="colophon" class="site-footer" role="contentinfo">
                ...
                <div class="site-info">
                    <div class="textwidget">
                        <p><a href="#">Copyright &copy; 2019 by fadebowaley</a></p>
                    </div>
                </div>
                <!-- .site-info -->
