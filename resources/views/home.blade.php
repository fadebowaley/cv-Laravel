<!DOCTYPE html>
<html lang="en" class="no-js one-page-layout sound-effects" data-audio-tick="audio/tick.mp3" data-click-ripple-animation="yes"><!-- InstanceBegin template="/Templates/layout.dwt" codeOutsideHTMLIsLocked="false" -->
    ...
    <div class="home-wrap">
            ...
            <div class="home-logo">
                ...
                <i class="home-logo-center">
                    ...
                    <span class="home-text-container">
                        <span class="home-text-container-placeholder">Demola Adebowale</span>
                    </span>
                    <span class="home-text">Demola Adebowale</span>
                </i>
                <i class="home-logo-right"><span>Front End Developer</span></i>
        ...
        <!-- .home-footer -->
        <p class="home-footer">&copy; 2019 Fadebowaley</p>
        <!-- .home-footer -->
