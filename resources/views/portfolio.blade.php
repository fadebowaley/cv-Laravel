<!DOCTYPE html>
<html lang="en" class="no-js classic-page-layout " data-audio-tick="audio/tick.mp3" data-click-ripple-animation="yes"><!-- InstanceBegin template="/Templates/layout.dwt" codeOutsideHTMLIsLocked="false" -->
    ...
    <head>
        ...
        <title>fadebowaley Profile</title>
		  	...
		  	<main id="main" class="site-main cd-main">
                ...
                <header id="masthead" class="header" role="banner">
                    ...
                    <div class="header-wrap layout-full">
                            ...
                            <div class="home-logo">
                                ...
                                <i class="home-logo-center">
                                    ...
                                    <span class="home-text-container">
                                        <p class="home-text-container-placeholder">Demola Adebowale</p>
                                    </span>
                                    <span class="home-text">Demola Adebowale</span>
                                </i>
                        ...
                        <a class="social-link facebook" href="https://facebook.com/fadebowaley"></a>
                        <a class="social-link twitter" href="https://twitter.com/fadebowaley"></a>
                        <a class="social-link linkedin" href="https;//linkedin/in/fadebowaley"></a>
                        <a class="social-link github" href="https://github.com/fadebowaley"></a>
                                        ...
                                        <div class="portfolio-items media-grid masonry" data-layout="masonry" data-item-width="360">
                                            ...
                                            <div class="media-cell illustration hentry">
                                                ...
                                                <div class="media-cell-desc">
                                                    <h3>Vans illustrations</h3>
                                                    <p class="category">by Leo Natsume</p>
                                                </div>
                                            ...
                                            <div class="media-cell media format-gallery hentry">
                                                <div class="media-box">
                                                    ...
                                                    <div class="mask"></div>
                                                    <!-- lightbox - gallery -->
                                                    <a href="images\portfolio\lightbox-01.jpg" class="lightbox" data-title="Portraits by MERCEDES DEBELLARD"></a>
                                                    <a href="images\portfolio\lightbox-02.jpg" class="lightbox" data-title="Portraits by MERCEDES DEBELLARD"></a>
                                                    <a href="images\portfolio\lightbox-03.jpg" class="lightbox" data-title="Portraits by MERCEDES DEBELLARD"></a>
                                                    <a href="images\portfolio\lightbox-04.jpg" class="lightbox" data-title="Portraits by MERCEDES DEBELLARD"></a>
                                                    <!-- lightbox - gallery -->
                                                </div>
                                                <div class="media-cell-desc">
                                            ...
                                            <div class="media-cell illustration video format-video hentry">
                                                ...
                                                <div class="media-box">
                                                    ...
                                                    <div class="mask"></div>
                                                    <!-- lightbox - video -->
                                                    <a href="https://vimeo.com/123320091" data-title="An Animated History of the Van" class="lightbox mfp-iframe"></a>
                                                    <!-- lightbox - video -->
                                                </div>
                                            ...
                                            <div class="media-cell media format-audio hentry">
                                                <div class="media-box">
                                                    ...
                                                    <a href="https://w.soundcloud.com/player/?visual=true&auto_play=true&url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F221650664&show_artwork=true" data-title="Time (feat. G-Eazy & Olivver the Kid)" class="lightbox mfp-iframe"></a>
                                            ...
                                            <div class="media-cell media hentry">
                                                ...
                                                <div class="media-cell-desc">
                                                    <h3>Branding Presentation Kit</h3>
                                                    <p class="category">an illustration work</p>
                                                </div>
                                            </div>
                                            <!-- portfolio-item -->
                                            ...
                                            <div class="media-cell media format-image hentry">
                                                <div class="media-box">
                                                    ...
                                                    <div class="mask"></div>
                                                    <!-- lightbox - image -->
                                                    <a href="images\portfolio\04.jpg" data-title="by MERCEDES DEBELLARD" class="lightbox"></a>
                                                    <!-- lightbox - image -->
                                                </div>
                                                <div class="media-cell-desc">
                                            ...
                                            <div class="media-cell media format-audio hentry">
                                                <div class="media-box">
                                                    ...
                                                    <div class="mask"></div>
                                                    <!-- lightbox - soundcloud : url copied from share/embed code -->
                                                    <a href="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/560005236&color=%23ff5500&auto_play=true&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" data-title="Too Future Mixes" class="lightbox mfp-iframe"></a>

                                                    <!-- lightbox - soundcloud -->
                                                </div>
                                                <div class="media-cell-desc">
                                                    <h3>Too Future. Guest Mix 108: Laxcity</h3>
                                                    <p class="category">lightbox soundcloud</p>
                                                </div>
                                            </div>
                                            <!-- portfolio-item - lightbox soundcloud -->
    ...
    <!-- InstanceEndEditable -->
        ...
        <!-- SCRIPTS -->
        <script src="js\tween-max.js"></script>
