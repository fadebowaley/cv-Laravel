                                ...
                                <article class="page hentry">
                                    ...
                                    <div class="entry-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 col-sm-3">
                                                    ...
                                                    <div class="fun-fact">
                                                        ...
                                                        <h4>fadebowaley[at] gmail.com</h4>
                                                    </div>
                                                    <!-- fun-fact -->
                                        ...
                                        @endif
                                            ...
                                            <form id="" class="" method="post" action="contact">
                                            {{csrf_field()}}
                                                <!-- enter name of sender  here -->
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="subject" >  <p>
                                                 <input placeholder="Name" type="text" name="name" id="name" class="required"> </p>
                                                @error('name')
                                                ...
                                                <!-- enter email  of sender  here -->
                                                  <p>
                                                    <textarea placeholder="Message" name="message" id="message" class="form-control textarea @error('message') is-invalid @enderror"></textarea>
                                                    @error('message')
                                                      <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                     </span>
                                                ...
                                                <p>
                                                    <button type="submit" class="submit button primary">Send</button>
                                                </p>
